        ...
        <tbody>
          @forelse($transactions as $tx)
            <tr class="border-b border-slate-100 hover:bg-slate-50 transition-colors">
              ...
              <td class="py-4 px-6 text-center">
                <a href="{{ route('transactions.struk', $tx->id) }}" class="inline-flex items-center justify-center w-9 h-9 text-blue-600 hover:bg-blue-50 rounded-xl transition-colors border border-slate-200">
