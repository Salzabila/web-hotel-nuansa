...
<div class="h-full">
  <div class="mb-5">
    ...
    <p class="text-slate-500 mt-1 text-sm">Buat akun admin atau kasir</p>
  </div>

  <form method="POST" action="{{ route('users.store') }}" class="bg-white p-6 rounded-xl shadow-sm border border-slate-100 max-w-2xl">
    @csrf
    ...
    <div class="space-y-4">
      ...
      <div>
        ...
        <input 
          type="password" 
          name="password" 
          class="w-full px-3 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('password') border-red-500 @enderror" 
